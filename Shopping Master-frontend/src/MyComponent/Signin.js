...
const Signin = () => {
  ...
  const getUserId = () => {
    axios
      .get(`${base_Url_Authorization}/validate`, {
        headers: {
      ...
      .then(
        (response) => {
          ...
          // console.log(localStorage.getItem("adminId") + " user Id Generated");
        },
        (error) => {
          toast.error("Error");
        }
  ...
  const authentication = (data) => {
    axios.post(`${base_Url_Authorization}/token`, data).then(
      (response) => {
        //console.log(response.data);
  ...
  return (
    <div className="h-full bg-gradient-to-tl from-blue-400 to-blue-800 w-full py-16 px-4">
  ...
  // return (
  //   <>
  //     <div className="mb-3 p-4 max-w-sm bg-white  m-auto mt-20 items-center rounded-lg border border-gray-200 shadow-md sm:p-6 lg:p-8 dark:bg-gray-800 dark:border-gray-700 mb-43">
